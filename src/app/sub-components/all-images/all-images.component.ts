...
export class AllImagesComponent implements OnInit {
    ...
    allImages = ['assets/shadows.png','assets/cable.png','assets/agree.png','assets/background/nda.png',
        'assets/fire-animation/fire-strips3.png','assets/fire-animation/fire-strips2.png','assets/fire-animation/fire-strips.png','assets/fire-animation/explosions.png','assets/roads.png','assets/enter.png','assets/en-logo.png','assets/title-en.png',
        'assets/presentation.png','assets/navbar/visual-development.png','assets/navbar/story-treatment.png','assets/navbar/presentation.png','assets/navbar/inspiration.png','assets/navbar/home.png','assets/navbar/contact.png','assets/navbar/biography.png','assets/music-credits.png','assets/music-credits-email.png',
        'assets/bird-shadow.png','assets/perso-premier-plan.png','assets/here.png',
